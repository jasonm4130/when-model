...
- a source that fails or times out (8 s) degrades to empty data and shows up in the **Source health** list rather than taking the page down; the early-warning and landed panels derive their LIVE / partial / OFFLINE pills from the same results;
